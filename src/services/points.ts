...
const messages:Record<string,string>={price_changed:'会员等级或价格已更新，请核对新价格后再次确认。',insufficient_points:'积分不足，余额已更新，请充值后重试。',content_unavailable:'这部作品或剧集已不可用。',session_expired:'登录已失效，请重新登录。',invalid_credentials:'登录已失效，请重新登录。',idempotency_conflict:'请求已发生变化，请关闭弹窗后重试。'};
