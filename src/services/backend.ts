...
export interface OrderDTO {id:string;status:'pending'|'processing'|'paid'|'closed'|'refunding'|'refunded';total:number;currency:'CNY';createdAt:string;offerId?:string;paidAt?:string;festivalRewards?:FestivalReward[]}
