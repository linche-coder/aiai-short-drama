...
export const metrics=[
 ['主动入口点击率','绿色首页主动点击入口的去重会话 / 绿色首页有效会话'],['门槛后实际进入率','完成门槛的去重会话 / 绿色首页有效会话'],['内容误曝光率','未获准或普通页面的成人内容项曝光 / 这些上下文全部内容项曝光；同时记录违规次数，目标为 0'],['完播率',`达到 ${completionThreshold*100}% 的有效观看 / 有效起播，排除测试与广告`],['追剧、付费与留存','按内容域、去重用户和观察窗口统计；共享套餐收入只计一次'],['门槛通过 / 退出率','按 gate_instance_id 去重；通过或退出 / 展示，拒绝与失败单列'],['悦享升级尊享转化率','服务端核实升级用户 / 看到升级入口的合资格悦享会员'],['私密历史清除率','有私密历史且执行清除的用户 / 同窗口有私密历史的用户；隐藏另计'],['投诉率','投诉事件 / 对应有效观看'],['退款 / 拒付率','服务端核实退款或拒付订单 / 同口径已支付订单']
];
