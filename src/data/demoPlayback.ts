...
export const demoPlayback={enabled:import.meta.env.DEV,count:36,groupSize:30};
...
export const demoUnlocked=(episode:DemoEpisode,tier:Tier)=>['free','basic','premium'].indexOf(tier)>=['free','basic','premium'].indexOf(episode.tier);
