...
export const festivalAssets={desktop:'/assets/festival/aiai-festival-v4-background-desktop.png',mobile:'/assets/festival/aiai-festival-v4-background-mobile.png',gift:'/assets/festival/moon-gift.png',completeTitle:'/assets/festival/aiai-festival-kv-complete-v6.png'};
export function FestivalArtwork({compact=false,portrait=false,immersive=false}:{compact?:boolean;portrait?:boolean;immersive?:boolean}){
 return <div className={`festival-artwork${compact?' festival-artwork--compact':''}`}>
  ...
  <img className="festival-title-art" src={festivalAssets.completeTitle} width="1536" height="1024" alt={`月满中秋，礼遇国庆，任务最高领${taskMaximum}积分；开通畅看会员，限时加赠畅看天数`}/>
